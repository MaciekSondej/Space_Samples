...
{
    public class APIRecieveAF2SB
    {
        private readonly ILogger<APIRecieveAF2SB> _logger;
        private readonly ISBService _ISBService;

        public APIRecieveAF2SB(ILogger<APIRecieveAF2SB> log, ISBService SBService)
        {
            _logger = log;
        ...
        {
            _logger.LogInformation("APIRecieveAF2SB Started processing.");
            try
            {
                ...
                if (data.isVeteran)
                {
                    ...
                    await _ISBService.SendApplicationToSB(data);
                }
                else
                {
